...
Underneath the bonnet, C++ `lua::State` maps to `lua51::LuaState` in R. The latter overloads `lua` by package and by class name; Lua appears twice, somewhat redundantly the second time. In R however, common usage first imports the package _then_ accesses the package contents without namespace qualifiers, making the second Lua in `LuaState` useful.
